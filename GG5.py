...
##kr1 = KRIS.LINE()
##kr1.login(qr=True)
##kr1.login(token="EpBtLiDY5FSxXULSKHwd.9/ooHDTJlc9/BT3oj3hnVq.f4QUA7p3UZRzFvhR479K90KC/x2ZYTY2P+3iGfsaDdw=")#satpam
##kr1.loginResult()
...
admin=["u0be40d5b6854cce0f78b76a7ace30727"]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                wait["Sider"] = True
                kr1.sendText(msg.to,"Sider,,main yuk 😆😆")                
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    kr1.sendText(msg.to, "Cek Sider Off")
                else:
                    kr1.sendText(msg.to, "Hihi Belom Di Set")                
                ...
                if msg.from_ in admin:
                    ...
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "ub807586941370c04ec9258caa6a798e1"}
                    kr1.sendMessage(msg)
            elif cms(msg.text,["creator","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ub807586941370c04ec9258caa6a798e1"}
                kr1.sendMessage(msg)
                kr1.sendText(msg.to,'❂➣ Creator GUCCI GANG  􀜁􀄯􏿿')
...
#==============================================================================#
                ...
                if msg.from_ in owner:
                    if msg.toType == 2:
                        if msg.toType == 2:
                            ...
                            kr1.sendText(msg.to,"Group di bersihkan...!!")
                            targets = []
                            for g in gs.members:
                ...
                if msg.from_ in owner:
                    ...
                    if msg.toType == 2:
                        ...
                        kr1.sendText(msg.to,"Qo salamnya gak ada yang jawab ya..!!")
                        kr1.sendText(msg.to,"hehehhehe")
                        targets = []
                        for g in gs.members:
                            if _name in g.displayName:
                                targets.append(g.mid)
                            ...
                            for target in targets:
                              if target not in admin:
                                try:
                                    ...
                                    kr1.sendText(msg.to,"السَّلاَمُ عَلَيْكُمْ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ")
                                    kr1.sendText(msg.to,"وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِوَبَرَكَاتُهُ")
                                    kr1.sendText(msg.to,"Nah salamnya jawab sendiri jadinya wkwkwk..!!")
...
#                            kr1.updateGroup(gs)
                ...
                try:
                    ...
                    kr1.sendMessage(M)
                    kr1.sendText(msg.to,"Gcreator Grup")
...
#==============================================================================#
                ...
                if msg.from_ in owner:
                    ...
                    h = kr1.getContact(mid)
                    h = kr1.getContact(mid2)
                    h = kr1.getContact(mid3)
                    h = kr1.getContact(mid4)
                    h = kr1.getContact(mid5)
                    kr1.sendText(msg.to,"═══[DisplayName]═══\n" + h.displayName)
                    kr1.sendText(msg.to,"═══[DisplayName]═══\n" + h.displayName)
                    kr1.sendText(msg.to,"═══[DisplayName]═══\n" + h.displayName)
                    kr1.sendText(msg.to,"═══[DisplayName]═══\n" + h.displayName)
...
#==============================================================================#
                ...
                if msg.from_ in admin:
                    kr1.sendText(msg.to,"👉First√")
                    kr1.sendText(msg.to,"👉Second√")
                    kr1.sendText(msg.to,"👉Third√")
                    kr1.sendText(msg.to,"👉Fourth√")
                    kr1.sendText(msg.to,"👉Fifth√")
...
#================================ KRIS SCRIPT STARTED ==============================================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u0be40d5b6854cce0f78b76a7ace30727"}
                kr1.sendMessage(msg)
...
#--------------------------------------------------------
                ...
                return
#--------------------------------------------------------
            elif "gucci spamtag @" in msg.text:
                if msg.from_ in owner:
                    _name = msg.text.replace("gucci spamtag @","")
                    _nametarget = _name.rstrip(' ')
                    gs = kr1.getGroup(msg.to)
                    for g in gs.members:
                        if _nametarget == g.displayName:
            ...
            elif msg.text in ["gucci glist"]: #Melihat List Group
                if msg.from_ in owner:
            ...
            elif "gucci asupka " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("gucci asupka ","")
                    if gid == "":
            ...
            elif msg.text in ["gucci muach"]:
                if msg.from_ in owner:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "ua7fb5762d5066629323d113e1266e8ca',"}
                    kr1.sendMessage(msg)
            elif msg.text in ["Gucci","gucci"]:
                if msg.from_ in owner:
                    kr1.sendText(msg.to,"Cab masih aktif Say...!!!")
#===============================================
        if op.type == 17:
            if op.param2 not in Bots:
